<div x-data="data()">
    <x-wire-card class="bg-white border-4 border-blue-300 rounded-xl mb-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <div class="lg:pt-6.5">
                <x-wire-button class="w-full" positive spinner="searchAvailability" wire:click="searchAvailability" :disabled="$appointmentEdit && !$appointmentEdit->status->isEditable()">
                    Buscar disponibilidad               
                </x-wire-button>
            </div>
        </div>
    ...
    @if ($appointment['date'])
                                    ...
                                    @foreach ($availability['schedules'] as $schedule)
                                        <li>
                                            <x-wire-button 
                                                ...
                                                :color="$schedule['disabled'] ? 'positive' : 'blue'"
                ...
                <div class="col-span-1">
                    <x-wire-card class="bg-white border-4 border-blue-300 rounded-xl">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <hr class="my-3">
                            <div class="space-y-6">
                                <x-wire-select label="Pacientes" placeholder="Seleccione un paciente"
                                ...
                                <x-wire-textarea label="Motivo de la cita" placeholder="Ingrese el motivo de la cita" wire:model="appointment.reason"/>
                                <x-wire-button class="w-full" positive
                                    wire:click="save"
                                    spinner="save">
                                    Confirmar cita
                                </x-wire-button>
        ...
        @else
            <x-wire-card class="bg-red-400 border-2 border-red-600 rounded-xl">
