...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Citas | Gerardo','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
    [
        'name' => 'Dashboard',
...
<?php endif; ?>
<?php $component->withAttributes(['blue' => true,'href' => ''.e(route('admin.appointments.create')).'']); ?>
...
[$__name, $__params] = $__split('admin.data-tables.appointment-table');

$__html = app('livewire')->mount($__name, $__params, 'lw-4076255239-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH D:\DW\CODE\citas\resources\views/admin/appointments/index.blade.php ENDPATH**/ ?>