...
<body class="min-h-screen gradient-bg medical-pattern bg-blue-900">
        ...
        <div class="w-full max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 items-center">         
            ...
            <div class="w-full max-w-md mx-auto slide-up" style="animation-delay: 0.3s;">
                <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
                    ...
                    <!-- Formulario -->
                    <form class="space-y-6" method="POST" action="<?php echo e(route('login')); ?>" onsubmit="handleLogin(event)">
                        <?php echo csrf_field(); ?>
                        <!-- Email -->
                        <div class="relative group">
                            ...
                            <div class="relative">
                                <input 
                                    ...
                                    autocomplete="off"
                                    class="w-full px-4 py-3 pl-12 border border-gray-300 rounded-xl 
                        ...
                        <div class="relative group">
                            ...
                            <div class="relative">
                                <input 
                                    ...
                                    name="password"
                                    id="password"
                                    class="w-full px-4 py-3 pl-12 pr-12 border border-gray-300 rounded-xl 
                                    focus:border-blue-500 focus:border-2 focus:outline-none
                                    transition-all duration-300 bg-gray-50 focus:bg-white"
                                    placeholder="••••••••"                                  
                                />
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a class="text-sm text-blue-600 hover:text-blue-800 transition-colors" href="<?php echo e(route('password.request')); ?>">
                        ...
                        <button type="submit"
                            id="loginButton"
                            class="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed">
    ...
    <div id="successNotification"
        class="fixed top-4 right-4 transform translate-x-full opacity-0 transition-all duration-300 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg">
        <div class="flex items-center">
            <i class="fas fa-check-circle mr-2 animate-spin"></i>
            <span id="loginText">Iniciando sesión...</span>
        </div>
    </div>   
    ...
    <?php if($errors->any()): ?>
        <div id="errorNotification"
            class="fixed top-4 right-4 transition-all transform translate-x-0 duration-300 bg-red-500 text-white px-6 py-3 rounded-lg shadow-lg">
            <div class="flex items-center">
        ...
        <script>
            setTimeout(() => {
                ...
                if (error) {
                    error.classList.add('translate-x-full', 'opacity-0');
                }
    ...
    <script>
        function handleLogin(event) {
            ...
            success.classList.remove('translate-x-full', 'opacity-0');
            success.classList.add('opacity-100');

            // Ahora dejamos que el form se envíe normalmente
            // un pequeño delay solo para que se vea el efecto
            setTimeout(() => {
                event.target.submit();
            }, 500);
        }
...
</html><?php /**PATH D:\DW\CODE\citas\resources\views/auth/login.blade.php ENDPATH**/ ?>