...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Usuarios | Gerardo','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
    [
        'name' => 'Dashboard',
...
<?php endif; ?>
<?php $component->withAttributes(['blue' => true,'href' => ''.e(route('admin.users.create')).'']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-8 bg-white border-4 border-blue-300 rounded-xl']); ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('admin.data-tables.user-table');

$__html = app('livewire')->mount($__name, $__params, 'lw-2267792492-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH D:\DW\CODE\citas\resources\views/admin/users/index.blade.php ENDPATH**/ ?>